  ...
  return (
    <section className="logview-panel" data-testid="log_view_container">
      ...
      >
        ...
        <span className="icon-btn" aria-label={collapsed ? 'Expand logs' : 'Collapse logs'}>
        ...
        <div className="logview-body" data-testid="log_view_list">
          {entries.length ? (
            entries.map((entry, index) => (
              ...
              >
                <span className="log-time" data-testid={`log_entry_${index}_timestamp`}>
                  {entry.timestamp}
                </span>
                <span
                ...
                <span className="log-text" data-testid={`log_entry_${index}_message`}>
